...
Namespace EBNF
    ...
    ''' 評価結果を表す構造体。
    ''' </summary>
    Public NotInheritable Class EBNFEvaluateAnswer

        ''' <summary>
        ''' 評価範囲を取得する。
        ''' </summary>
        ''' <returns>評価範囲。</returns>
        Public ReadOnly Property Range As EBNFAnalysisItem
        ...
        Public Sub New(rng As EBNFAnalysisItem, value As Object)
            Me.Range = rng
            Me.Value = value
        End Sub
