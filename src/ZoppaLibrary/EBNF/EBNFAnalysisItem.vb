...
Namespace EBNF
    ...
    ''' 解析の範囲を表します。
    ''' </summary>
    Public NotInheritable Class EBNFAnalysisItem
        ...
        ''' 範囲内の解析結果のリストを取得します。
        ''' </summary>
        Private _answers As List(Of EBNFAnalysisItem)
        ...
        ''' 範囲内のサブレンジのリストを取得します。
        ''' </summary>
        Public ReadOnly Property SubRanges As IEnumerable(Of EBNFAnalysisItem)
            Get
                Return Me._answers
            End Get
        End Property
