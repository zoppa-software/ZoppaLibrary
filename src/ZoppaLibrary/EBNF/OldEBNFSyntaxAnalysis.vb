...
Namespace EBNF
    ...
    ''' </summary>
    Public Module OldEBNFSyntaxAnalysis
        ...
        Public Function CompileToEvaluate(rules As IPositionAdjustReader,
            ...
            If answerEnv.RuleTable.ContainsKey(ident) Then
                ...
                '' 解析実行
                'Dim res = answerEnv.RuleTable(ident).Match(target, answerEnv, Nothing, answerEnv.MethodTable, ident, answers)
        ...
        Public Function Evaluate2(env As EBNFEnvironment, ident As String, target As IPositionAdjustReader) As EBNFAnalysisItem
            If env.RuleTable.ContainsKey(ident) Then
                ...
                '' 解析実行
                'Dim res = env.RuleTable(ident).Match(target, env, Nothing, env.MethodTable, ident, answers)
