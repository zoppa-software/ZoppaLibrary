...
Namespace Analysis
    ...
    ''' この構造体は、改行を表現します。
    ''' </summary>
    NotInheritable Class BrExpression
        Implements IExpression

        ' インスタンス
        Private Shared ReadOnly _instance As New Lazy(Of BrExpression)(Function() New BrExpression())

        ''' <summary>
        ''' 改行式のインスタンスを取得します。
        ''' このインスタンスは、常に同じ空の式を返します。
        ''' </summary>
        Public Shared ReadOnly Property Instance As BrExpression
            Get
        ...
        Public ReadOnly Property Type As ExpressionType Implements IExpression.Type
            Get
                Return ExpressionType.BrExpression
            End Get
        End Property
